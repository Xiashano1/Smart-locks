...
/////////////////////////////////////用户配置区///////////////////////////////////	 
#define USE_HORIZONTAL  			0	//定义是否使用横屏 		0,不使用(竖屏); 1,使用.
...
void LCD_BL_SET(void);
void LCD_BL_CLR(void);
